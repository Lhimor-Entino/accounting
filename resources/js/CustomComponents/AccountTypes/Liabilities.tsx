...
const Liabilities = (props: Props) => {
    ...
    return (
        <div className='w-full'>
            ...
            {
                filterType.toLocaleLowerCase() === "accounts payable" ? 
                <AccountPayableList accounts={accounts} /> :
                filterType.toLocaleLowerCase() ==="advances to officers" ?
                <AdvancesToOfficers accounts={accounts} />:""
            }
        </div>
    )
}
