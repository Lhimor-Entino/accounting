...
import {
  ...
  const LeaseHoldImprovementList = (props: Props) => {
    const { accounts } = props
    const [data, setData] = useState<Account[]>(accounts)
  
    // GET ALL ACCOUNT TYPE Vehicle
    useEffect(() => {
      const filteredData = accounts.filter((a: Account) => a.account_sub_id === 11) // 7 HERE MEANS Vehicle
...
export default LeaseHoldImprovementList
