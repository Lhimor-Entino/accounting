...
const AdvancesToEmployeesList = (props: Props) => {
    const { accounts } = props
    const [data, setData] = useState<Account[]>(accounts)
  
    // GET ALL ACCOUNT TYPE Advances To Employees
    useEffect(() => {
      const filteredData = accounts.filter((a: Account) => a.account_sub_id === 4) // 1 HERE MEANS ATE
...
export default AdvancesToEmployeesList