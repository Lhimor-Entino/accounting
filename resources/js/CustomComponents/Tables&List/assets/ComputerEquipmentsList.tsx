...
import {
  ...
  const ComputerEquipmentsList = (props: Props) => {
    const { accounts } = props
    const [data, setData] = useState<Account[]>(accounts)
  
    // GET ALL ACCOUNT TYPE Computer Equipments
    useEffect(() => {
      const filteredData = accounts.filter((a: Account) => a.account_sub_id === 9) // 7 HERE MEANS CE
...
export default ComputerEquipmentsList